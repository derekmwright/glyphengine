...
// The lit vertex stage for LOD instance buckets (LitLODVert).
//
...
//
// LitLODFrag consumes location 5 as coverage. Ordinary instance sets use
// LitInstancedVert and LitFrag, whose interfaces remain independent.
